...
export default function Home() {
  ...
  const onSubmit = async (data: any) => {
    setIsLoading(true);
    try {
      const response = await axios.post('http://157.245.4.44/api/Auth/Login', data);
  ...
  return (
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-white">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <Image className="mx-auto h-10 w-auto" src="/logo.jpeg" alt="Peek Entertainment" width={400} height={400}/>
