...
import {BASE_URL, GET_ALL_CREATORS, GetSUPPORT} from "@/constant";
...
export default function Support() {
    ...
    const fetchAllCreators = async () => {
        ...
        await api.get(`${GetSUPPORT}?${queryParams}`,)
            .then((response) => {
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <caption
                        ...
                        Support Request
                        <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Browse all support requests and feedback</p>
                    </caption>
                    ...
                    {createors.map((data) => <tr key={data.id}
                        ...
                        <td className="px-6 py-4">
                            I am not seeing my Subscription
                        </td>
                        <td className="px-6 py-4">
                            2
                        </td>
                        ...
                        <td className="px-6 py-4 text-right">
                            <button
                                ...
                                className="font-medium text-green dark:text-green-500 hover:underline mr-7">View
                            </button>
                            <Link href={'/dashboard/creators/' + data.id}
                                  className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Resolve</Link>
                        </td>
                    </tr>)}
                    </tbody>
                </table>
