          ...
          <aside id="logo-sidebar"
              ...
              <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                  <ul className="space-y-2 font-medium">
                      ...
                      <li>
                          <Link href="/dashboard/creators-request"
                             className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                                 pathname === "/dashboard/creators-request" ? "bg-gray-200 dark:bg-gray-700" : "" // Highlight active page
                             }`}                          >                              <svg
                              ...
                              <span className="flex-1 ms-3 whitespace-nowrap">Creators Request</span>
                          </Link>
                      </li>
                      <li>
                          <Link href="/dashboard/creators"
                             className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                              ...
                              <span className="flex-1 ms-3 whitespace-nowrap">All Creators</span>
                          </Link>
                      </li>
                      <li>
